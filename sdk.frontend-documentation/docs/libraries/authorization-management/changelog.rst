.. _changelog-authorization-management:

Changelog - Authorization Management
====================================

This changelog refers to the ``@viasoft/authorization-management`` library.
...
.. list-table::
   ...
   * - stylelint-config-standard
     - 🔄 Updated
     - ``~29.0.0``
     - `stylelint-config-standard <https://github.com/stylelint/stylelint-config-standard/blob/main/README.md>`_
   * - stylelint-config-standard-scss
     - 🔄 Updated
     - ``^6.1.0``
     - `stylelint-config-standard-scss <https://github.com/stylelint-scss/stylelint-config-standard-scss/blob/main/README.md>`_
   * - stylelint-scss
     - 🔄 Updated
     - ``~4.3.0``
     - `stylelint-scss <https://github.com/stylelint-scss/stylelint-scss/blob/master/README.md>`_
   * - tsickle
     - ❌ Removed
     -
     -
...
* `FRM-1856 <http://jira.korp.com.br/browse/FRM-1856>`_\ : All API endpoints are now prefixed with ``VS_API_PREFIX``.
